...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Piron.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Piron-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  piron-qt [" + tr("command-line options") + "]                     " + "\n";
